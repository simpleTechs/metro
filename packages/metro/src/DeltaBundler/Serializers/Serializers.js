...
/**
  ...
  {var _ref16 =
    ...
    yield RamBundle.getRamOptions(
    options.entryFile,
    {
      dev: options.dev,
      platform: options.platform }, (

    yield deltaTransformer.getDependenciesFn()),
    getTransformOptions);const preloadedModules = _ref17.preloadedModules,ramGroups = _ref17.ramGroups;
  ...
  });return function getRamBundleInfo(_x14, _x15, _x16) {return _ref15.apply(this, arguments);};})();let getAssets = (() => {var _ref18 = _asyncToGenerator(
  ...
  {var _ref19 =
    ...
    modules.map((() => {var _ref20 = _asyncToGenerator(function* (module) {
        ...
        return null;
      });return function (_x20) {return _ref20.apply(this, arguments);};})()));


    return assets.filter(Boolean);
  });return function getAssets(_x17, _x18, _x19) {return _ref18.apply(this, arguments);};})();let _build = (() => {var _ref21 = _asyncToGenerator(
  ...
  });return function _build(_x21, _x22, _x23) {return _ref21.apply(this, arguments);};})();function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};}const DeltaPatcher = require('../DeltaPatcher');const RamBundle = require('./RamBundle');const stableHash = require('metro-cache/src/stableHash');const toLocalPath = require('../../node-haste/lib/toLocalPath');var _require = require('../../Assets');const getAssetData = _require.getAssetData;var _require2 = require('../../Bundler/util');const createRamBundleGroups = _require2.createRamBundleGroups;var _require3 = require('metro-source-map');const fromRawMappings = _require3.fromRawMappings;
